...
module _ {a}{A : Set a}{x y : A} where
  ...
  ≔'≔'-red : ∀ {c d δE}(E : Map A δE){lA : c ∈D δE}{lB : d ∈D δE}
    → DiffDom lA lB
    → (E [ lA ]≔' x) [ lB ]≔' y ≡ (E [ lB ]≔' y) [ lA ]≔' x
  ≔'≔'-red (E , c₁ ↦ v) (h/t l) = refl
  ≔'≔'-red (E , c₁ ↦ v) (t/h l) = refl
  ≔'≔'-red (E , c₁ ↦ v) (t/t d₁) rewrite ≔'≔'-red E d₁ = refl
-- -}
-- -}
-- -}
-- -}
