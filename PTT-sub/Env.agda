...
open import PTT-sub.Dom as Dom
open import PTT-sub.Session as Session hiding (Ended)

module PTT-sub.Env where

open import PTT-sub.Map as Map public
...
E-lookup-same : ∀ {c δE S}(lA : c ∈D δE)(E : Env δE)
  → (E [ lA ]≔' S) ‼ lA ≡ S
E-lookup-same here (E , c ↦ v) = refl
E-lookup-same (there l) (E , c₁ ↦ v) = E-lookup-same l E

E-lookup-diff : ∀ {c d δE S}{lA : c ∈D δE}{lB : d ∈D δE}(E : Env δE)
  → DiffDom lA lB → (E [ lA ]≔' S) ‼ lB ≡ E ‼ lB
